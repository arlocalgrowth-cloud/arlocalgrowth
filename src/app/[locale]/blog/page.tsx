...
import { blogPosts, getLocalizedPost, formatDate } from "@/lib/blog";
import { ArrowRight, Clock, Tag } from "lucide-react";

const meta: Record<string, { title: string; description: string; headline: string; sub: string; read: string }> = {
  de: {
    ...
    headline: "Blog — Google Maps & Local SEO Tipps",
  ...
  en: {
    ...
    headline: "Blog — Google Maps & Local SEO Tips",
  ...
  ru: {
    ...
    headline: "Блог — советы по Google Maps и Local SEO",
              ...
              return (
                ...
                >
                  <div className="flex flex-wrap gap-2 mb-3">
                    {localized.tags.slice(0, 2).map((tag) => (
                      <span
                        key={tag}
